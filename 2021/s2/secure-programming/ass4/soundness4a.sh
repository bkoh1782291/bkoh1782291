...
RUNDIR=`mktemp -d  SND-SPA4.XXXXX` || runerror "Cannot create test run directory"
...
hasFile "assignment4.pdf" || error "$FILE: No assignment4.pdf"
...
cc -I. -o driver ../driver.c spalloc.c -lm || cc -DNEEDMAIN -I. -o driver ../driver.c spalloc.c -lm || error "Compiling driver.c failed"
cd ..
